...
import sys
sys.path.append('/ailab/group/pjlab-ai4s/ai4earth/wangzhengyi/air_model_V2/')
from wzy_func import find_nc_files, find_npy_files, find_files_with_keyword, create_folder
...
# 加载图像数据和目标值
relative_path = '/ailab/group/pjlab-ai4s/ai4earth/wangzhengyi/'
GEMS_path = os.path.join(relative_path, 'data/air/GEMS_V2/hourly')
TROPOMI_path = os.path.join(relative_path, 'data/air/TROPOMI_V2/daily')
...
train_list = os.path.join(relative_path, 'air_model_V2/V2_Satellite_Datesets/SatelliteSets/VT_train.txt')
...
# 保存模型
output_model = '/ailab/group/pjlab-ai4s/ai4earth/wangzhengyi/air_model_V2/baseline/LightGBM/code/VT_LightGBM_model_hourly_GEOS.txt'
bst.save_model(output_model)

# 加载模型进行推理
save_path = '/ailab/group/pjlab-ai4s/ai4earth/wangzhengyi/air_model_V2/baseline/LightGBM/predict/VT_LightGBM_hourly_GEOS'
if not os.path.exists(save_path):
    os.makedirs(save_path)

test_list = os.path.join(relative_path, 'air_model_V2/V2_Satellite_Datesets/SatelliteSets/VT_all.txt')
