...
rf = RandomForestRegressor(n_estimators=10, 
    max_features='sqrt',      # 减少每棵树的最大特征数
    random_state=42,n_jobs=-1)

# 训练随机森林回归器
rf.fit(X, target_vector)
# 保存模型
output_model='/ailab/group/pjlab-ai4s/ai4earth/wangzhengyi/air_model_V2/baseline/RF/code/VT_4_RF_model_hourly_GEOS.pkl'
