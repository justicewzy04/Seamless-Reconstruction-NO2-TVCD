...
save_path = OUTPUT_ROOT / "baselines" / "linear_regression" / "predictions"
...
# 加载模型
model_path = env_path("UFILL_LINEAR_REGRESSION_MODEL", OUTPUT_ROOT / "baselines" / "linear_regression" / "model.pkl")
