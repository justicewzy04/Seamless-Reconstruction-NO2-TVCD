...
save_path='/ailab/group/pjlab-ai4s/ai4earth/wangzhengyi/air_model_V2/baseline/OLR/predict/VT_hourly_GEOS'
...
# 加载模型
with open('/ailab/group/pjlab-ai4s/ai4earth/wangzhengyi/air_model_V2/baseline/OLR/code/VT_OLR_model_hourly_GEOS.pkl', 'rb') as f:
...
for i in range(len(test_lines)):
    ...
    nc_file = Dataset(os.path.join(save_path, test_lines[i][0:8]+'_OLR.nc'), 'w', format='NETCDF4')
